...
export const parsePayment = (payment: ExpensePayment, expense: CCExpense): Payment => {
    return {
        ...
        expenseNoInstallments: expense.installments,
        expenseAcquiredAt: expense.acquiredAt,
    ...
    return periods.map((period) => {
        ...
        subscriptions.forEach((subscription) => {
            ...
            payments.push({
                ...
                expenseNoInstallments: subscription.installments,
                expenseAcquiredAt: subscription.acquiredAt,
